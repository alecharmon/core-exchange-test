...
// AccountPaymentNetworkList - An optionally paginated array of payment networks supported by the account
type AccountPaymentNetworkList struct {

	Page PageMetadata `json:"page,omitempty"`

	// Array of payment networks. Plaid expects your organization to return an empty array if this information isn't available. Not all deposit accounts support ACH transfers. For example, a prepaid debit card account doesn't support ACH. 
	PaymentNetworks []AccountPaymentNetwork `json:"paymentNetworks"`
}
