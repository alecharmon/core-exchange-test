...
// AccountWithDescriptor - This provides an instance of an account without full details
type AccountWithDescriptor struct {

	DepositAccount AccountDescriptor `json:"depositAccount"`

	LoanAccount AccountDescriptor `json:"loanAccount"`

	LocAccount AccountDescriptor `json:"locAccount"`

	InvestmentAccount AccountDescriptor `json:"investmentAccount"`

	InsuranceAccount AccountDescriptor `json:"insuranceAccount"`

	AnnuityAccount AccountDescriptor `json:"annuityAccount"`
}
