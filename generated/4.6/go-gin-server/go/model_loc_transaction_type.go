...
package openapi
// LocTransactionType : The type of a line of credit (LOC) transaction. Plaid passes through all LOC transaction types. 
type LocTransactionType string

// List of LocTransactionType
const (
	ADJUSTMENT LocTransactionType = "ADJUSTMENT"
	CHECK LocTransactionType = "CHECK"
	FEE LocTransactionType = "FEE"
	INTEREST LocTransactionType = "INTEREST"
	PAYMENT LocTransactionType = "PAYMENT"
	WITHDRAWAL LocTransactionType = "WITHDRAWAL"
)
