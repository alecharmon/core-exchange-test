...
type Transactions struct {
	...
	// An array of transactions with entity type dependent on the account type.  Plaid expects your organization to return an empty array if this information isn't available. Plaid consumes solely deposit, loan, and line of credit transactions. 
	Transactions []OneOfobjectobjectobject `json:"transactions"`
}
