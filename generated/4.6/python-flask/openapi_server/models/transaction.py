...
class Transaction(Model):
    ...
    def __init__(self, transaction_id=None, reference_transaction_id=None, posted_timestamp=None, transaction_timestamp=None, description=None, debit_credit_memo=None, category=None, sub_category=None, status=None, amount=None, foreign_amount=None, foreign_currency=None):  # noqa: E501
        """Transaction - a model defined in OpenAPI

        :param transaction_id: The transaction_id of this Transaction.  # noqa: E501
        :type transaction_id: str
        :param reference_transaction_id: The reference_transaction_id of this Transaction.  # noqa: E501
        :type reference_transaction_id: str
        :param posted_timestamp: The posted_timestamp of this Transaction.  # noqa: E501
        :type posted_timestamp: datetime
        :param transaction_timestamp: The transaction_timestamp of this Transaction.  # noqa: E501
        :type transaction_timestamp: datetime
        :param description: The description of this Transaction.  # noqa: E501
        :type description: str
        :param debit_credit_memo: The debit_credit_memo of this Transaction.  # noqa: E501
        ...
        :type amount: float
        :param foreign_amount: The foreign_amount of this Transaction.  # noqa: E501
        :type foreign_amount: float
        :param foreign_currency: The foreign_currency of this Transaction.  # noqa: E501
    ...
    def reference_transaction_id(self):
        """Gets the reference_transaction_id of this Transaction.

        Value for a unique identifier  # noqa: E501

        :return: The reference_transaction_id of this Transaction.
        :rtype: str
        """
    ...
    def reference_transaction_id(self, reference_transaction_id):
        """Sets the reference_transaction_id of this Transaction.

        Value for a unique identifier  # noqa: E501

        :param reference_transaction_id: The reference_transaction_id of this Transaction.
        :type reference_transaction_id: str
        """
    ...
    def posted_timestamp(self):
        """Gets the posted_timestamp of this Transaction.
        ...
        :return: The posted_timestamp of this Transaction.
        :rtype: datetime
        """
    ...
    def posted_timestamp(self, posted_timestamp):
        """Sets the posted_timestamp of this Transaction.

        ISO 8601 date-time in format 'YYYY-MM-DDThh:mm:ss.nnn[Z|[+|-]hh:mm]' according to [IETF RFC3339](https://xml2rfc.tools.ietf.org/public/rfc/html/rfc3339.html#anchor14)  # noqa: E501

        :param posted_timestamp: The posted_timestamp of this Transaction.
        :type posted_timestamp: datetime
        """
    ...
    def debit_credit_memo(self):
        """Gets the debit_credit_memo of this Transaction.


        :return: The debit_credit_memo of this Transaction.
    ...
    def debit_credit_memo(self, debit_credit_memo):
        """Sets the debit_credit_memo of this Transaction.


        :param debit_credit_memo: The debit_credit_memo of this Transaction.
        :type debit_credit_memo: DebitCreditMemo
        """
    ...
    def sub_category(self):
        """Gets the sub_category of this Transaction.

        Transaction category detail  # noqa: E501

        :return: The sub_category of this Transaction.
        :rtype: str
        """
    ...
    def sub_category(self, sub_category):
        ...
        :param sub_category: The sub_category of this Transaction.
        :type sub_category: str
        """
    ...
    def foreign_amount(self):
        """Gets the foreign_amount of this Transaction.
        ...
        :return: The foreign_amount of this Transaction.
        :rtype: float
        """
    ...
    def foreign_amount(self, foreign_amount):
        """Sets the foreign_amount of this Transaction.

        The amount of money in the foreign currency. If this amount is specified, then Plaid expects that the `foreignCurrency` property is also set.  # noqa: E501

        :param foreign_amount: The foreign_amount of this Transaction.
        :type foreign_amount: float
        """
    ...
    def foreign_currency(self):
        """Gets the foreign_currency of this Transaction.


        :return: The foreign_currency of this Transaction.
        :rtype: Iso4217Code
        """
    ...
    def foreign_currency(self, foreign_currency):
        """Sets the foreign_currency of this Transaction.


        :param foreign_currency: The foreign_currency of this Transaction.
        :type foreign_currency: Iso4217Code
        """
