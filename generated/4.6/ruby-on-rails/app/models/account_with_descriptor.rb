...
class AccountWithDescriptor < ApplicationRecord
  validates_presence_of :deposit_account
  validates_presence_of :loan_account
  validates_presence_of :loc_account
  validates_presence_of :investment_account
  validates_presence_of :insurance_account
  validates_presence_of :annuity_account
