...
// AccountWithDetails - This provides an instance of an account with full details
type AccountWithDetails struct {

	DepositAccount DepositAccount `json:"depositAccount"`

	InvestmentAccount InvestmentAccount `json:"investmentAccount"`

	LoanAccount LoanAccount `json:"loanAccount"`

	LocAccount LocAccount `json:"locAccount"`
}
