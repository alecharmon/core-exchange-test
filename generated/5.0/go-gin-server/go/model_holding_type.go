...
package openapi
// HoldingType : Plaid maps the holding type to the Plaid [security type](https://plaid.com/docs/api/products/investments/#investments-transactions-get-response-securities-type). Plaid expects you to return `OTHER` and set the `holdingSubType` to indicate cash-type holdings (CASH, MONEYMARKET). 
type HoldingType string

// List of HoldingType
const (
	ANNUITY HoldingType = "ANNUITY"
	BOND HoldingType = "BOND"
	CD HoldingType = "CD"
	MUTUALFUND HoldingType = "MUTUALFUND"
	OPTION HoldingType = "OPTION"
	OTHER HoldingType = "OTHER"
