...
// Transactions - Optionally paginated array of transactions
type Transactions struct {

	Page PageMetadata `json:"page,omitempty"`

	// An array of transactions with entity type dependent on the account type.  Plaid expects your organization to return an empty array if this information isn't available. Plaid consumes solely investment, deposit, loan, and line of credit transactions. 
	Transactions []OneOfobjectobjectobjectobject `json:"transactions"`
}
