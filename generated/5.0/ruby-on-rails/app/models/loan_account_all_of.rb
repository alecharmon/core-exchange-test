...
class LoanAccountAllOf < ApplicationRecord
  validates_presence_of :account_number
  validates_presence_of :principal_balance
  validates_presence_of :originating_date
  validates_presence_of :interest_rate
  validates_presence_of :interest_rate_type
