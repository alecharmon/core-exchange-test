...
Rails.application.routes.draw do
  ...
  add_openapi_route 'GET', '/fdx/v5/accounts/{accountId}', controller_name: 'account_information', action_name: 'get_account'
  add_openapi_route 'GET', '/fdx/v5/accounts', controller_name: 'account_information', action_name: 'list_accounts'
  add_openapi_route 'GET', '/fdx/v5/accounts/{accountId}/transactions', controller_name: 'account_transactions', action_name: 'list_account_transactions'
  add_openapi_route 'GET', '/fdx/v5/accounts/{accountId}/payment-networks', controller_name: 'payment_networks_information', action_name: 'get_account_payment_networks'
  add_openapi_route 'GET', '/fdx/v5/accounts/{accountId}/contact', controller_name: 'personal_information', action_name: 'get_account_contact'
  add_openapi_route 'GET', '/fdx/v5/customers/current', controller_name: 'personal_information', action_name: 'get_customer_id'
end
